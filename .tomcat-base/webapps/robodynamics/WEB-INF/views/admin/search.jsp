...
<body class="rd-shell-page">
  ...
  <div class="rd-shell">
    <section class="rd-hero">
      <div>
        <p class="rd-eyebrow">Robo Dynamics Command Search</p>
        <h1 class="rd-hero-title">Admin Search</h1>
        <p class="rd-hero-sub">
          Search across courses, offerings, and students with quick drill-down into learner details.
        </p>
      </div>
      <div class="rd-hero-meta">
        ...
        <div class="rd-meta-card">
          ...
          <div class="rd-meta-value">Unified Search</div>
        </div>
      </div>
    </section>

    <div class="rd-content rd-search-toolbar">
