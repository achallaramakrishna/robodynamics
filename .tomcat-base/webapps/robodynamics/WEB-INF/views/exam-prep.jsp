...
<head>
    ...
    <title>Exam Prep | AptiPath Career Discovery</title>
...
<main class="page">
    <section class="hero">
        ...
        <h1>Board-aligned revision that follows Career Discovery signals.</h1>
        <p>
    ...
    <div class="cta-grid">
        <article class="module-card">
            ...
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/plans/checkout?plan=exam-basic">Start Basic Plan</a>
        </article>
        <article class="module-card">
