...
// Arena challenge pool — will be replaced with Kannada content in Phase 2
const hindiChallengePool: { id: string; question: string; answer: string; grade: string }[] = [];
...
export default function KaveriArenaEngine() {
  ...
  useEffect(() => {
    const regJson =
      typeof window !== "undefined"
        ? localStorage.getItem("kaveri_student") || localStorage.getItem("hs_arena_registration")
        : null;
          ...
          {gameState === "FINISHED" ? (
            ...
            >
              ...
              <div style={{ fontSize: 17, color: COLORS.textSub, marginBottom: 24 }}>
                You scored {score} points in the Kaveri Arena.
              </div>
              <button
                onClick={() => router.push("/")}
                style={{
            ...
            <div style={{ maxWidth: 860, width: "100%", display: "grid", gap: 28 }}>
              ...
              >
                ...
                {currentQuestion.image ? (
                  ...
                  >
                    <img src={currentQuestion.image} alt="Challenge visual" style={{ maxHeight: 240, maxWidth: "100%", objectFit: "contain" }} />
                  </div>
                ) : null}
