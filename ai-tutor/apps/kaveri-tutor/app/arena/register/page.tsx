...
import { KaveriBrandHeader, KaveriBrandFooter } from "@/components/Kaveri/BrandChrome";
...
export default function ArenaRegistration() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    localStorage.setItem("kaveri_student", registration);
    ...
    <div style={{
      ...
      <div style={{ zIndex: 10, maxWidth: "480px", width: "100%" }}>
        <div style={{ marginBottom: "40px" }}>
          <KaveriBrandHeader title="Academy Arena" subtitle="Student Registration" />
        </div>
