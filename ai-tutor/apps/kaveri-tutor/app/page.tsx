...
const levels = [
  {
    id: 1,
    title: "Akshara Adventure",
    kannadaTitle: "ಅಕ್ಷರ",
    desc: "Public-ready alphabet journey with Kannada sounds, tracing, and joyful picture memory.",
    topics: ["All 13 vowels", "Early consonant clusters", "Tracing and quick checks"],
    badge: "Open Now",
    color: "#f97316",
    icon: "ಅ",
  },
  ...
  },
  {
    ...
    kannadaTitle: "ವಾಕ್ಯ",
    desc: "Short Kannada sentences with bridge-language guidance and speaking confidence.",
      ...
      >
        ...
        >
          <Link href="/" style={{ textDecoration: "none", color: "#172033", display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <div>
              <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: -0.5 }}>Kaveri</div>
              <div style={{ fontSize: 12, color: "#5b6475", fontWeight: 700 }}>AI tutor for Kannada literacy</div>
            </div>
          </Link>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 20, lineHeight: 1.65, color: "#556070", maxWidth: 760, margin: "0 0 28px" }}>
              Kaveri helps children see, hear, trace, and remember Kannada letters with bright visuals, supportive coaching,
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                {[
                  { char: "ಅ", word: "ಅಕ್ಕ", color: "#f97316" },
                  { char: "ಆ", word: "ಆನೆ", color: "#22c55e" },
                  { char: "ಇ", word: "ಇರುವೆ", color: "#3b82f6" },
                  { char: "ಕ", word: "ಕಮಲ", color: "#ec4899" },
                  { char: "ಗ", word: "ಗಿಳಿ", color: "#8b5cf6" },
                  { char: "ಪ", word: "ಪಾಪ", color: "#f59e0b" },
                ].map((card) => (
                  <div
                    key={card.char}
                    style={{
            ...
            return (
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <div style={{ fontSize: 16, color: "#334155", fontWeight: 700, marginBottom: 12 }}>{level.kannadaTitle}</div>
