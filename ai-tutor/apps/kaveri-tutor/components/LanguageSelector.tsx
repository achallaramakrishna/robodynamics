...
const LANGUAGE_OPTIONS: LanguageMode[] = ['kannada-full', 'kannada-english', 'english-simplified'];
        ...
        >
          {LANGUAGE_OPTIONS.map((lang, idx) => (
            ...
            >
              ...
              >
                {lang === 'kannada-full' && 'For native Kannada speakers'}
                {lang === 'kannada-english' && 'For bilingual learners'}
                {lang === 'english-simplified' && 'For non-Kannada speakers'}
              </div>
            </button>
          ))}
        </div>
