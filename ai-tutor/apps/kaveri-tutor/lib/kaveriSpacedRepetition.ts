/**
 * Kaveri Spaced Repetition Engine
 * SM-2 inspired algorithm for Kannada character learning review
 */
...
export interface LearnedChar {
  ...
  level?: number;            // Kaveri level (1–6). Undefined = legacy (treated as level 1).
}

const STORAGE_KEY = "kaveri_learned_chars";
 ...
 * @param char - The Kannada character (e.g., "ಅ")
 * @param word - The Kannada word example (e.g., "Akka")
 * @param wordEng - The English translation (e.g., "sister")
