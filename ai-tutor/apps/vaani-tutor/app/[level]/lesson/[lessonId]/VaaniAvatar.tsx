...
interface VaaniAvatarProps {
  speaking?: boolean;
  size?: number;
  name?: string;
}

export default function VaaniAvatar({ speaking = false, size = 180, name }: VaaniAvatarProps) {
  return (
    <div
      style={{
        width: size,
    ...
    >
      ...
      {speaking && (
        <div
          style={{
            ...
            animation: "vaani-glow 1.2s ease-in-out infinite",
            pointerEvents: "none",
            zIndex: 0,
          }}
        />
      ...
      {/* Vaani tutor image — full character, no crop */}
      <img
        src="/vaani/vaani_tutor.png"
        alt={name || "Vaani AI Tutor"}
        style={{
          width: "100%",
          height: "auto",
          display: "block",
