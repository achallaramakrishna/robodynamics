...
- Generated: 2026-03-15T06:18:16.310710+00:00
...
| --- | --- | --- | --- | --- |
| L2_DOUBLING_HALVING | Lesson 2: Doubling and Halving | **84.0** | 📈 B | Answer Acceptance (33.3) |
| L11_VINCULUM_INTRO | Lesson 11: General Multiplication | **80.7** | 📈 B | Answer Acceptance (33.3) |
...
| L14_FACTORISATION | Lesson 14: Fractions | **78.2** | 📈 B | Answer Acceptance (33.3) |
| L16_CUBES_INTRO | Lesson 16: The Crowning Gem (Advanced Di | **78.0** | 📈 B | Answer Acceptance (0.0) |
| L12_FRACTIONS_DECIMALS | Lesson 12: Squaring | **77.9** | 📈 B | Answer Acceptance (33.3) |
| L5_ALL_FROM_9_LAST_FROM_10 | Lesson 5: All from 9 and Last from 10 | **77.2** | 📈 B | Answer Acceptance (0.0) |
| L9_GENERAL_MULTIPLICATION | Lesson 9: Bar Numbers | **77.2** | 📈 B | Answer Acceptance (0.0) |
| L13_ALGEBRAIC_IDENTITIES | Lesson 13: Equations | **72.2** | ⚠️  C | Answer Acceptance (0.0) |
| L15_SQUARES_NEAR_BASE | Lesson 15: Special Division | **72.2** | ⚠️  C | Answer Acceptance (0.0) |
| L6_NIKHILAM_BASE_10_100 | Lesson 6: Number Splitting | **72.2** | ⚠️  C | Answer Acceptance (0.0) |
| L10_DIVISION_BY_9 | Lesson 10: Special Multiplication | **71.9** | ⚠️  C | Answer Acceptance (0.0) |
| L7_SQUARES_ENDING_5 | Lesson 7: Base Multiplication | **71.9** | ⚠️  C | Answer Acceptance (0.0) |
| L4_VERTICAL_CROSSWISE | Lesson 4: Left to Right Arithmetic | **70.8** | ⚠️  C | Answer Acceptance (0.0) |
| L8_YAVADUNAM | Lesson 8: Checking and Divisibility | **69.7** | ⚠️  C | Answer Acceptance (0.0) |

**Overall Average: 75.8 / 100 — 📈 B**
...
**Teacher Line issues:**
- Group G: no intro/teach beat found
- Group H: no intro/teach beat found
- Group I: no intro/teach beat found
...
**Answer Acceptance issues:**
- L7_A_BASE10_56: check-answer HTTP 400
