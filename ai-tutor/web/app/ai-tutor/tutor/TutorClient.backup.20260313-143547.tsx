...
// â”€â”€ Speaking teacher â€“ gesture per cue â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Viseme sequence for lip-sync â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Male teacher (avatar_1) â€“ full-body SVG per cue â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Cue â†’ single best-fit sprite from the 51-sprite pack (r=row, c=col).
...
// Sprites cycled while speaking â€” slow gesture changes (2.5 s each), crossfaded smoothly.
// Pick poses that feel "engaged explaining" â€” not wildly different so crossfade looks natural.
const MALE_TEACHER_SPEAKING_CYCLE = [
  "/avatar_1/sprite_r01_c11.svg",  // open arms â€” neutral engaging
  "/avatar_1/sprite_r02_c01.svg",  // arms spread â€” enthusiastic
  "/avatar_1/sprite_r03_c05.svg",  // pointing/guiding â€” confident
  "/avatar_1/sprite_r04_c04.svg",  // hands together â€” thoughtful
];
...
// â”€â”€ Vedic Sutra names per chapter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const CHAPTER_SUTRAS: Record<string, string> = {
  ...
  L3_MULTIPLY_BY_11: "Anurupyena â€” Proportionality",
  L4_VERTICAL_CROSSWISE: "Urdhva-Tiryagbhyam â€” Vertical and Crosswise",
  L5_ALL_FROM_9_LAST_FROM_10: "All from 9 and the Last from 10",
  L6_NIKHILAM_BASE_10_100: "Nikhilam â€” Near Base Method",
  L7_SQUARES_ENDING_5: "By One More than the One Before",
  L8_YAVADUNAM: "Yavadunam â€” Whatever the Deficiency",
  L9_GENERAL_MULTIPLICATION: "Urdhva-Tiryagbhyam â€” General Case",
  L10_DIVISION_BY_9: "Paravartya Yojayet â€” Transpose and Apply",
  L11_VINCULUM_INTRO: "Vinculum â€” Negative Digit Representation",
  L12_FRACTIONS_DECIMALS: "Anurupyena â€” Proportional Fractions",
  L13_ALGEBRAIC_IDENTITIES: "Anurupye Sunyam â€” Proportionately Zero",
  L14_FACTORISATION: "Adyam Adyena â€” First by First",
  L15_SQUARES_NEAR_BASE: "Yavadunam â€” Near Base Squares",
  L16_CUBES_INTRO: "Anurupyena â€” Cubes by Pattern",
};

// â”€â”€ Worked example lines for DEMO slide (board animation) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const CHAPTER_DEMO_STEPS: Record<string, Array<{ text: string; color?: string; size?: number }>> = {
  L1_COMPLETING_WHOLE: [
    ...
    { text: "Step 1 â€” Base = 10  (our target)", color: "#0369a1", size: 14 },
    { text: "Step 2 â€” 7 + ? = 10", color: "#334155", size: 15 },
    { text: "Answer:  10 âˆ’ 7 = 3", color: "#065f46", size: 18 },
    { text: "Check: 7 + 3 = 10  âœ“   (Sutra confirmed!)", color: "#7c2d12", size: 12 },
  ],
  L2_DOUBLING_HALVING: [
    { text: "Question: Double 36", color: "#334155", size: 14 },
    { text: "Step 1 â€” Split: 36 = 30 + 6", color: "#0369a1", size: 14 },
    { text: "Step 2 â€” Double each: 60 + 12", color: "#334155", size: 14 },
    { text: "Answer: 60 + 12 = 72", color: "#065f46", size: 18 },
    { text: "Twice as fast as long multiplication!", color: "#7c2d12", size: 12 },
  ],
  L3_MULTIPLY_BY_11: [
    { text: "Question: 34 Ã— 11 = ?", color: "#334155", size: 14 },
    { text: "Step 1 â€” Write the outer digits: 3 _ 4", color: "#0369a1", size: 14 },
    { text: "Step 2 â€” Insert their sum: 3+4 = 7", color: "#334155", size: 14 },
    { text: "Answer: 374", color: "#065f46", size: 20 },
    { text: "No multiplication table needed!", color: "#7c2d12", size: 12 },
  ],
  L4_VERTICAL_CROSSWISE: [
    { text: "Question: 23 Ã— 14 = ?", color: "#334155", size: 14 },
    { text: "V-Right: 3Ã—4=12 â†’ write 2, carry 1", color: "#0369a1", size: 13 },
    { text: "Crosswise: 2Ã—4+3Ã—1=11+1=12 â†’ write 2, carry 1", color: "#334155", size: 12 },
    { text: "V-Left: 2Ã—1=2+1=3", color: "#334155", size: 13 },
    { text: "Answer: 322", color: "#065f46", size: 20 },
  ],
  L5_ALL_FROM_9_LAST_FROM_10: [
    { text: "Question: 100 âˆ’ 37 = ?", color: "#334155", size: 14 },
    { text: "Step 1 â€” 'All from 9': 9 âˆ’ 3 = 6", color: "#0369a1", size: 14 },
    { text: "Step 2 â€” 'Last from 10': 10 âˆ’ 7 = 3", color: "#334155", size: 14 },
    { text: "Answer: 63", color: "#065f46", size: 20 },
    { text: "Instant subtraction â€” no borrowing!", color: "#7c2d12", size: 12 },
  ],
  L6_NIKHILAM_BASE_10_100: [
    { text: "Question: 97 Ã— 98 (base 100)", color: "#334155", size: 14 },
    { text: "Step 1 â€” Deviations: 97â†’âˆ’3,  98â†’âˆ’2", color: "#0369a1", size: 13 },
    { text: "Step 2 â€” Left: 97+(âˆ’2)=95  or  98+(âˆ’3)=95", color: "#334155", size: 12 },
    { text: "Step 3 â€” Right: (âˆ’3)Ã—(âˆ’2)=06", color: "#334155", size: 13 },
    { text: "Answer: 9506", color: "#065f46", size: 20 },
  ],
  L7_SQUARES_ENDING_5: [
    { text: "Question: 35Â² = ?", color: "#334155", size: 14 },
    { text: "Step 1 â€” Prefix: 3 Ã— (3+1) = 3 Ã— 4 = 12", color: "#0369a1", size: 13 },
    { text: "Step 2 â€” Attach 25", color: "#334155", size: 14 },
    { text: "Answer: 1225", color: "#065f46", size: 20 },
    { text: "Any number ending in 5, instant square!", color: "#7c2d12", size: 12 },
  ],
};

// â”€â”€ Spoken DEMO narration per chapter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Speaking teacher avatar (layered sprite system) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function SpeakingTeacher({
  ...
  // Sprite-cycle index for male teacher speaking animation (0â€“3)
  ...
  // Viseme cycling when speaking (~110 ms per shape = ~9 fps) â€” SVG teacher_1 only
  useEffect(() => {
  ...
  // Periodic auto-blink every 3â€“7 s
  useEffect(() => {
  ...
  // â”€â”€ Male teacher: cycling sprite gesture + CSS speaking rhythm â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (avatar.style === "male") {
    const cueKey = (cue || "").toLowerCase();
    // Cue/feedback-based sprite (shown when idle, or when feedback overrides)
    const cueSrc =
      feedback === true  ? "/avatar_1/sprite_r03_c06.svg"   // happy wave â€” correct!
      : feedback === false ? "/avatar_1/sprite_r05_c05.svg"  // concerned â€” wrong answer
      : (MALE_TEACHER_SPRITE_BY_CUE[cueKey] ?? MALE_TEACHER_SPRITE_BY_CUE.default);
    // While speaking (no feedback override) â†’ cycle through 4 gesture sprites
    ...
    return (
      ...
      >
        ...
        {/* key changes when sprite changes â†’ triggers spriteFadeIn CSS animation */}
...
// â”€â”€ Lesson intro slide builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Builds SVG board steps for the 3-slide lesson intro (EXPLAIN â†’ DEMO â†’ GUIDED).
// Runs BEFORE the first question. Pure function â€” no React hooks.
function buildIntroSlideBoardSteps(
  ...
  if (slide === 1) {
    // â”€â”€ EXPLAIN: Sutra name + learning goals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    addT("s1_badge", 16, 22, "EXPLAIN  â€”  Step 1 of 3: Here is the Concept", "#94a3b8", 11);
    ...
    learningGoals.slice(0, 3).forEach((g, i) => {
      const truncated = g.length > 70 ? `${g.slice(0, 68)}â€¦` : g;
      addT(`s1_g${i}`, 24, 138 + i * 24, `â€¢ ${truncated}`, "#0f172a", 13);
    });
    addT("s1_next", 16, 240, "â–º Next: Watch a worked example on the board", "#64748b", 11);
  } else if (slide === 2) {
    // â”€â”€ DEMO: Step-by-step worked example â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const demoLines = CHAPTER_DEMO_STEPS[chapterCode] || [
      { text: "Step 1 â€” Identify the base or pattern", color: "#0369a1", size: 14 },
      { text: "Step 2 â€” Apply the Sutra rule", color: "#334155", size: 14 },
      { text: "Step 3 â€” Write the answer", color: "#065f46", size: 16 },
    ];
    addT("s2_badge", 16, 22, "DEMO  â€”  Step 2 of 3: Watch Me Solve One", "#94a3b8", 11);
    ...
    addT("s2_next", 16, 310, "â–º Next: Your turn!", "#64748b", 11);
  } else {
    // â”€â”€ GUIDED: Student transition â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    addT("s3_badge", 16, 22, "GUIDED  â€”  Step 3 of 3: Now You Try", "#94a3b8", 11);
    ...
    addT("s3_r1", 28, 140, "â€¢ Read the question carefully", "#0f172a", 13);
    addT("s3_r2", 28, 162, "â€¢ Use the Sutra step by step", "#0f172a", 13);
    addT("s3_r3", 28, 184, "â€¢ Type your answer and click Check Answer", "#0f172a", 13);
    addT("s3_r4", 28, 206, "â€¢ Ask me a doubt any time using the doubt panel", "#0f172a", 13);
    addT("s3_ready", 16, 248, "Ready? Let us begin! âœ“", avatar.color, 17);
  }
...
function TutorContent() {
  ...
  async function speak(text: string): Promise<void> {
    ...
    if ("speechSynthesis" in window) {
      ...
      // Priority: Google/Microsoft quality voices â†’ any male en-IN voice â†’ any en-IN voice
      const voices = window.speechSynthesis.getVoices();
      const pick =
        voices.find(v => /google.*en.*in/i.test(v.name)) ||
        voices.find(v => /microsoft.*ravi/i.test(v.name)) ||  // Microsoft Ravi â€” Indian male
        voices.find(v => v.lang === "en-IN" && v.name.toLowerCase().includes("male")) ||
        voices.find(v => v.lang === "en-IN") ||
        voices.find(v => v.lang.startsWith("en") && !v.name.toLowerCase().includes("female")) ||
        null;
      if (pick) utter.voice = pick;
      utter.rate  = 1.0;   // natural pace â€” lively for Grade 4-8
  ...
  async function copySessionId() {
    ...
    try {
      ...
      setTeacherUtterance("ðŸ“Œ Session ID copied.");
    } catch {
  ...
  // Unlock browser audio context on first user gesture â€” must happen synchronously
    ...
    try {
      ...
      if (data.correct) {
        if (nextStreak > 0 && nextStreak % 3 === 0) {
          ...
          setTeacherUtterance(`ðŸ”¥ ${nextStreak} streak! Outstanding consistency, keep going.`);
        } else {
    ...
    async function runKickoff() {
      try {
        if (pendingKickoff === "welcome") {
          ...
          // â”€â”€ Slide 1: EXPLAIN â€” Sutra name + learning goals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          // â”€â”€ Slide 2: DEMO â€” Step-by-step worked example â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          // â”€â”€ Slide 3: GUIDED transition â€” "Now you try" â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <main className={`container tutor-shell${status === "ready" ? " tutor-shell-live" : ""}`}>
      {/* â”€â”€ Quick-start screen: Raj intro â†’ start â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {status !== "ready" ? (
          ...
          <div className="tutor-qs-actions">
            ...
            {!canStart && (
              <p className="muted" style={{ fontSize: "0.85rem", marginTop: "0.5rem", textAlign: "center" }}>
                Session token missing â€” launch from the LMS
              </p>
            )}
      ...
      {status === "ready" && question ? (
        ...
        <div className="vedic-mission-app">
          <header className="vedic-topbar">
            ...
            <div className="vedic-topbar-stats">
              <div className="vedic-stat-pill heart">â™¥ {sessionProgress.hearts}/{sessionProgress.maxHearts}</div>
              <div className="vedic-stat-pill xp">âš¡ {sessionProgress.xp} XP</div>
              <div className="vedic-stat-pill streak">ðŸ”¥ {sessionProgress.streak}</div>
              <div className="vedic-stat-pill points">{missionPoints} pts</div>
              <div className="vedic-stat-pill">ðŸŽ¯ {score.accuracyPct}%</div>
                  ...
                  {lessonPath.map((item, idx) => (
                    ...
                    >
                      <span className="vedic-path-badge">
                        {item.status === "completed" ? "âœ“" : item.status === "locked" ? "ðŸ”’" : item.exerciseGroup}
                      </span>
                      ...
                      <div className="vedic-board-frame">
                        {showBoardPanel ? (
                          ...
                          <div className="ca-board-idle">
                            {awaitingStudentResponse ? (
                              <>
                                <span className="ca-idle-icon">âœï¸</span>
                                <p className="ca-idle-text">Try it first, then open the board if needed.</p>
                              </>
                            ) : (
                              <>
                                <span className="ca-idle-icon">ðŸ“‹</span>
        ...
        <div className={`ca-app${minimalDuolingoLayout ? " ca-app-minimal" : ""}`}>
          ...
          {/* â”€â”€ Slim progress strip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          <div className="ca-strip">
            ...
            <span className="ca-strip-stat">â™¥ {sessionProgress.hearts}/{sessionProgress.maxHearts}</span>
            <span className="ca-strip-stat">âš¡ {sessionProgress.xp} XP</span>
            <span className="ca-strip-stat">ðŸ”¥ {sessionProgress.streak}</span>
            {minimalDuolingoLayout ? (
              <span className="ca-strip-stat ca-strip-points">{missionPoints} pts</span>
            ) : null}
            <span className="ca-strip-stat">ðŸŽ¯ {score.accuracyPct}%</span>
            <span className="ca-strip-stat muted">{classElapsedLabel}</span>
          </div>

          {/* â”€â”€ Coach layout: left panel + right content â”€â”€â”€â”€â”€â”€â”€ */}
          <div className="ca-body">

            {/* â”€â”€ LEFT: Coach panel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                  ...
                  {lessonPath.map((item) => (
                    ...
                    >
                      <span className="ca-ex-dot">
                        {item.status === "completed" ? "âœ“" : item.status === "locked" ? "ðŸ”’" : "â€º"}
                      </span>
            ...
            {/* â”€â”€ RIGHT: Content panel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                ...
                {showBoardPanel ? (
                  ...
                  <div className="ca-board-idle">
                    {awaitingStudentResponse ? (
                      ...
                      <>
                        <span className="ca-idle-icon">ðŸ“‹</span>
                        <p className="ca-idle-text">Board ready â€” click Teach on Board</p>
                      </>
                    )}
                  </div>
                )}
                ...
                <div className={`ca-question${awaitingStudentResponse ? " spotlight" : ""}`}>
                  ...
                  {sessionProgress.livesDepleted ? (
                    <p style={{ marginTop: "0.35rem", marginBottom: 0, color: "#b91c1c", fontWeight: 700 }}>
                      ðŸ’” No hearts left. Do review to refill and continue.
                    </p>
                  ) : null}
                  <div className="udemy-answer-actions">
                    <button className="button" onClick={() => void checkAnswer()} disabled={isEvaluatingAnswer || !canAttemptAnswer}>
                      {isEvaluatingAnswer ? "Checking..." : "Check âœ…"}
                    </button>
                    <button
                      className="button secondary"
                      type="button"
                  ...
                  {check ? (
                    <div className={`udemy-feedback ${check.correct ? "correct" : "wrong"}`}>
                      <p className="udemy-feedback-verdict">
                        {check.correct ? "âœ… Correct! ðŸŽ‰" : "âŒ Try Again ðŸ’ª"}
                      </p>
                      <p className="muted">{check.encouragement}</p>
                      {check.coachTip ? <p className="muted">ðŸ’¡ Tip: {check.coachTip}</p> : null}
                      <p><strong>Expected:</strong> {check.expectedAnswer}</p>
                      <p style={{ marginBottom: 0 }}><strong>Explanation:</strong> {check.explanation}</p>
                    </div>
                  ) : null}
      ...
      <style jsx global>{`
        ...
        /* â”€â”€ Speaking Teacher (layered sprite avatar) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .speaking-teacher {
          position: relative;
          width: min(100%, 240px);
        ...
        /* â”€â”€ Male teacher (static sprite + CSS animation) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        ...
        /* Speaking rhythm: subtle body energy â€” no gesture changes, CSS does all the work */
        ...
        /* Gesture â€“ arm overlay (bottom half of figure) */
        .st-gesture {
          z-index: 2;
        ...
        /* Expression â€“ face overlay (top ~38% of figure) */
        .st-expression {
          z-index: 3;
        ...
        /* Viseme â€“ mouth overlay (~30% from top, centred) */
        .st-viseme {
          z-index: 4;
        ...
        /* Blink â€“ eyes overlay (very top, centred) */
        .st-blink {
          z-index: 5;
        ...
        /* â”€â”€ Coach-A Layout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .ca-app {
          display: flex;
          flex-direction: column;
          height: 100dvh;
        ...
        .udemy-devtools > summary::before { content: "â–¶  "; font-size: 0.6rem; }
        .udemy-devtools[open] > summary::before { content: "â–¼  "; }
        .udemy-devtools-body {
          padding: 0.75rem;
          display: flex;
          flex-direction: column;
