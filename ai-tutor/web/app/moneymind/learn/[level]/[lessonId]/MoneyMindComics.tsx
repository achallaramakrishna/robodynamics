  ...
  return (
    <div style={{
      ...
      {panels.map((panel, i) => (
        ...
        >
          {/* Speech bubble — sits above character with clear gap */}
          ...
          {/* Character — clearly separated below the bubble tail */}
          <div style={{ position: "relative", transform: panel.flip ? "scaleX(-1)" : undefined }}>
            ...
            {panel.item && (
              <span style={{
                position: "absolute", bottom: 4, right: -10, fontSize: 28,
                transform: panel.flip ? "scaleX(-1)" : undefined,
          ...
          <div style={{
            ...
            color: "#E2E8F0", letterSpacing: 0.5, textTransform: "uppercase",
          }}>
