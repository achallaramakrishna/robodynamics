...
export default function PassbookViewer({ data = {} }: { data?: any }) {
  const [transactions, setTransactions] = useState<Transaction[]>(() => {
    if (data.entries) {
      return data.entries.map((e: any, i: number) => ({
        ...
        debit: e.type === 'DR' ? e.amount : null,
        credit: e.type === 'CR' ? e.amount : null,
        balance: e.amount, // Basic initial balance mapping
      }));
    }
