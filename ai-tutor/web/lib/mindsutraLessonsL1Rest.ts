  ...
  steps: [
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_2_TABLES_11_TO_19/ekadhikena-pattern-card.svg",
        },
      },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_2_TABLES_11_TO_19/pattern-table-grid.svg",
        },
      },
      explanation: {
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_2_TABLES_11_TO_19/ones-tens-pattern-strip.svg",
        },
      },
      practice: {
        mode: "numeric",
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          example: "14 × 8 = 112",
          assetPath: "/math-svgs/level_1/VM_L1_2_TABLES_11_TO_19/product-sequence-ladder.svg",
        },
      },
      explanation: {
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_2_TABLES_11_TO_19/table-comparison-panel.svg",
        },
      },
      practice: {
        mode: "quiz",
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_3_DOUBLING_HALVING/factor-morph-panel.svg",
        },
      },
      practice: {
        mode: "numeric",
  ...
  steps: [
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_4_MULT_BY_11/two-digit-by-11-panel.svg",
        },
      },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          example: "76 × 11 = 836",
          assetPath: "/math-svgs/level_1/VM_L1_4_MULT_BY_11/x11-three-box-layout.svg",
        },
      },
      explanation: {
        title: "Common mistake to avoid",
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_4_MULT_BY_11/x11-middle-sum-strip.svg",
        },
      },
      practice: {
        mode: "quiz",
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_6_MULT_BY_5_25/factor-conversion-strip.svg",
        },
      },
      explanation: {
        title: "Common mistake to avoid",
...
export const VM_L1_7_LESSON: MindSutraLessonPayload = {
  ...
  steps: [
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          answer: 186,
          assetPath: "/math-svgs/level_1/VM_L1_7_NEAR_100/near-base-adjustment-bar.svg",
        },
      },
      explanation: {
        title: "Key idea",
    ...
    },
    {
      ...
      explanation: { title: "Mixed signs", body: "103 deviation = +3, 96 deviation = −4. The combined deviation is −1, so the answer is 200 − 1 = 199." },
      practice: {
        mode: "mcq",
        prompt: "What is the combined deviation in 103 + 96?",
        answer: -1,
        options: ["-7", "-1", "+1", "+7"],
        ...
        challenge: {
          prompt: "Transfer check: if the combined deviation is −1, what is the full answer to 103 + 96?",
          answer: 199,
          options: ["189", "199", "201", "209"],
          skillKeys: ["near_100_adjustments", "deviation_tracking"],
          hints: [
            "Start from 200 because both numbers are near 100",
            "Then apply the combined deviation −1",
            "200 − 1 = 199",
          ],
        },
      },
    ...
    },
    {
      ...
      practice: {
        mode: "mcq",
        prompt: "What total deviation do 98 and 93 make from 200?",
        answer: -9,
        options: ["-11", "-9", "+9", "+11"],
        skillKeys: ["near_100_adjustments", "deviation_tracking"],
        hints: [
        ...
        remediation: {
          prompt: "Checkpoint: what is the deviation of 93 from 100?",
          answer: -7,
          options: ["-9", "-7", "+7", "+9"],
          skillKeys: ["deviation_tracking"],
          hints: [
            "93 is 7 below 100",
            "Below 100 means negative deviation",
            "So the deviation is −7",
          ],
        },
        challenge: {
          prompt: "Transfer check: if the total deviation is −9, what is the full answer to 98 + 93?",
          answer: 191,
          options: ["189", "191", "193", "209"],
          skillKeys: ["near_100_adjustments", "deviation_tracking"],
          hints: [
            "Start from 200",
            "Apply the total deviation −9",
            "200 − 9 = 191",
          ],
        },
      },
  ...
  steps: [
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "32 × 21",
          prompt: "Ones → cross → hundreds. First lock the middle cross-sum.",
          assetPath: "/math-svgs/level_1/VM_L1_8_CRISS_CROSS_2DIG/diagonal-arrow-set-2digit.svg",
        },
      },
      ...
      practice: {
        mode: "mcq",
        prompt: "What is the middle cross-sum in 32 × 21?",
        answer: 7,
        options: ["5", "6", "7", "8"],
        skillKeys: ["criss_cross_2_digit"],
        hints: [
          "The middle step uses both diagonals",
          "3×1 + 2×2 = 3 + 4 = 7",
          "Then the full answer becomes 672",
        ],
        remediation: {
          prompt: "Checkpoint: how many diagonal products are added in the middle step of a 2-digit criss-cross?",
          answer: 2,
          options: ["1", "2", "3", "4"],
          skillKeys: ["criss_cross_2_digit"],
          hints: [
            "The middle band is the crossed band",
            "One diagonal comes from 3×1 and the other from 2×2",
            "So the middle step has 2 diagonal products",
          ],
        },
        challenge: {
          prompt: "Transfer check: after the cross-sum 7, what full answer do you read for 32 × 21?",
          answer: 672,
          options: ["627", "672", "702", "762"],
          skillKeys: ["criss_cross_2_digit"],
          hints: [
            "Ones stays 2",
            "Middle stays 7",
            "Hundreds is 3×2 = 6, so the answer is 672",
          ],
        },
      },
      actions: [
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_1/VM_L1_8_CRISS_CROSS_2DIG/carry-normalization-lane.svg",
        },
      },
      practice: {
        mode: "mcq",
        prompt: "What digit do you write in the ones place for 47 × 36?",
        answer: 2,
        options: ["2", "4", "6", "8"],
        skillKeys: ["criss_cross_2_digit", "carry_from_ones"],
        hints: [
          "Ones: 7×6 = 42",
          "Write the ones digit first and carry the tens digit",
          "So you write 2 and carry 4",
        ],
        remediation: {
          prompt: "Checkpoint: when 7×6 = 42, what number gets carried to the next step?",
          answer: 4,
          options: ["2", "3", "4", "6"],
          skillKeys: ["carry_from_ones"],
          hints: [
            "42 has a ones digit and a tens digit",
            "You write 2 and carry the tens digit",
            "So the carry is 4",
          ],
        },
        challenge: {
          prompt: "Transfer check: after writing 2 and carrying 4, what is the middle band total for 47 × 36 before splitting carry again?",
          answer: 49,
          options: ["45", "47", "49", "52"],
          skillKeys: ["criss_cross_2_digit", "carry_from_ones"],
          hints: [
            "Middle = 4×6 + 7×3 + carry 4",
            "24 + 21 + 4 = 49",
            "That means write 9 and carry 4",
          ],
        },
      },
      actions: [
