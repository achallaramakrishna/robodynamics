...
export const VM_L3_3_LESSON: MindSutraLessonPayload = {
  ...
  steps: [
    ...
    {
      id: "guided_practice", label: "Guided Practice",
      tutorText: "Try 7 × 6 using base 10. Find both deviations.",
      board: {
        type: "practice_board",
        data: {
          expression: "7 × 6 (base 10)",
          prompt: "Deviations from 10: 7→−3, 6→−4. Left = ? Right = ?",
          assetPath: "/math-svgs/level_3/VM_L3_3_NIKHILAM_BASE10/any-base-cross-board.svg",
        },
      },
      ...
      practice: {
        ...
        hints: [
          "Deviations: −3 and −4",
          "Left: 7−4=3. Right: 3×4=12 → write 2, carry 1 to left: 3+1=4",
          "Answer: 42",
        ],
      },
      actions: [
    ...
    {
      id: "challenge", label: "Challenge",
      tutorText: "Now try 995 × 998 using base 1000.",
      board: {
        type: "practice_board",
        data: {
          expression: "995 × 998 (base 1000)",
          prompt: "Deviations: −5 and −2. Right side = 3 digits.",
          assetPath: "/math-svgs/level_3/VM_L3_3_NIKHILAM_BASE10/nikhilam-base-line-1000.svg",
        },
      },
      practice: {
        mode: "numeric",
        prompt: "Solve: 995 × 998",
        answer: 993010,
        hints: [
          "Deviations: 995−1000=−5, 998−1000=−2",
          "Left: 995−2=993. Right: 5×2=10 → 3 digits: 010",
          "Answer: 993010",
        ],
      },
      actions: [
...
export const VM_L3_6_LESSON: MindSutraLessonPayload = {
  ...
  steps: [
    ...
    },
    {
      ...
      explanation: { title: "Steps", body: "Right: 9 (no carry). Middle: 24 → write 4, carry 2. Left: 16+2=18. Answer: 1849." },
      practice: {
        mode: "numeric",
        prompt: "Solve: 43²",
        answer: 1849,
        hints: [
          "Right: 3²=9 (no carry)",
          "Middle: 2×4×3=24 → write 4, carry 2",
          "Left: 4²=16 + carry 2 = 18 → Answer: 1849",
        ],
      },
      actions: [
        { id: "check", label: "Check answer", primary: true },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "89²",
          prompt: "a=8, b=9. Right: 9²=81. Big carries ahead.",
      ...
      practice: {
        ...
        answer: 7921,
        hints: [
          "Right: 81 → write 1, carry 8",
          "Middle: 2×8×9=144 + 8 = 152 → write 2, carry 15",
          "Left: 64 + 15 = 79 → Answer: 7921",
        ],
      },
      actions: [
        { id: "check", label: "Check answer", primary: true },
...
export const VM_L3_7_LESSON: MindSutraLessonPayload = {
  ...
  steps: [
    ...
    },
    {
      ...
      explanation: { title: "Steps", body: "q₁=1, working=2. q₂=2, adjust: 2−2×1=0. Remainder=0. Quotient: 12." },
      practice: {
        mode: "numeric",
        prompt: "Solve: 132 ÷ 11",
        answer: 12,
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "2197 ÷ 13",
          prompt: "Flag=3. Work through 4 digits.",
          assetPath: "/math-svgs/level_3/VM_L3_7_PARAVARTYA_DIV/adjustment-step-panel.svg",
        },
      },
      practice: {
        mode: "numeric",
        prompt: "Solve: 2197 ÷ 13",
        answer: 169,
        hints: [
          "q₁=2, adjust: 1−2×3=−5 → reduce q₁ to 1: 1−1×3=−2... try q₁=1, adjust 1−3=−2",
          "This is more complex — use: 2197÷13=169",
          "Answer: 169",
        ],
      },
      actions: [
