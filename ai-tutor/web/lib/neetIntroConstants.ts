  ...
  BIO_PLANT_PHYSIO: {
    ...
    slides: [
      ...
      },
      {
        ...
        diagramCaption: "Photosynthesis Process: Inputs → Chloroplast → Outputs | Light reactions in thylakoid produce ATP/NADPH | Calvin cycle in stroma fixes CO₂ into glucose",
      },
      {
        slide: "guided",
