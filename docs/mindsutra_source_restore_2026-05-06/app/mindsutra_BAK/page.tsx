...
// /mindsutra - Level-Based MindSutra Vedic Math Landing Page
...
export default function MindSutraPage() {
  ...
  const waUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi! I want to join the MindSutra early access program.")}`;
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ color: "#818CF8", fontWeight: 800, fontSize: 20 }}>MindSutra</span>
          <span style={{
        ...
        <div style={{ display: "flex", gap: 24, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 300px", maxWidth: 380, background: "linear-gradient(135deg, #1E1B4B, #0F172A)", border: "2px solid #8B5CF6", borderRadius: 16, padding: "32px", position: "relative", display: "flex", flexDirection: "column" }}>
            ...
            <ul style={{ padding: 0, margin: "0 0 32px", listStyle: "none", display: "flex", flexDirection: "column", gap: 12, flex: 1 }}>
              ...
              <li style={{ color: "#E2E8F0", fontSize: 14 }}>+ MindSutra Champion Trophy</li>
            </ul>
      ...
      <footer style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontWeight: 700, color: "#64748B" }}>MindSutra</span>
