  ...
  steps: [
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "94 × 97",
          prompt: "Deviation of 94 = −6. Deviation of 97 = ?",
...
export const VM_L2_3_LESSON: MindSutraLessonPayload = {
  ...
  steps: [
    ...
    {
      id: "guided_practice", label: "Guided Practice",
      tutorText: "Try 112 × 213. Work column by column. Start with ones: 2×3.",
      board: {
        type: "practice_board",
        data: {
          expression: "112 × 213",
          prompt: "5 columns from right to left.",
      ...
      practice: {
        mode: "numeric",
        prompt: "Solve: 112 × 213",
        answer: 23856,
        hints: [
          "Ones: 2×3 = 6",
          "Tens: 1×3 + 2×1 = 5",
          "Hundreds: 1×3 + 1×1 + 2×2 = 8, Thousands: 1×1+1×2=3, Ten-th: 1×2=2",
          "Answer: 23856",
        ],
      },
      actions: [
    ...
    {
      id: "challenge", label: "Challenge",
      tutorText: "Now try 234 × 111. Carries will appear — track them carefully.",
      board: {
        type: "practice_board",
        data: {
          expression: "234 × 111",
          prompt: "All 5 columns — watch for carries.",
          assetPath: "/math-svgs/level_2/VM_L2_3_CRISS_CROSS_3DIG/carry-normalization-lane-3digit.svg",
        },
      },
      practice: {
        mode: "numeric",
        prompt: "Solve: 234 × 111",
        answer: 25974,
        hints: [
          "Ones: 4×1=4. Tens: 3×1+4×1=7. Hundreds: 2×1+3×1+4×1=9",
          "Thousands: 2×1+3×1=5. Ten-thousands: 2×1=2",
          "Answer: 25974",
        ],
      },
      actions: [
  ...
  steps: [
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "231 ÷ 9",
          prompt: "Running digit sums give the quotient. What is 2+3?",
      ...
      practice: {
        mode: "numeric",
        prompt: "What is the quotient of 231 ÷ 9?",
        answer: 25,
        hints: [
          "Bring down 2 → q₁ = 2",
          "2 + 3 = 5 → q₂ = 5",
          "5 + 1 = 6 → remainder = 6, quotient = 25",
        ],
      },
      actions: [
        { id: "check", label: "Check answer", primary: true },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "3241 ÷ 9",
          prompt: "Running sums — remember to adjust if remainder ≥ 9.",
          assetPath: "/math-svgs/level_2/VM_L2_4_DIVISION_BY_9/final-remainder-highlight.svg",
        },
      },
      practice: {
        mode: "numeric",
        prompt: "What is the quotient of 3241 ÷ 9?",
        answer: 360,
        hints: [
          "q₁=3, 3+2=5 → q₂=5, 5+4=9 → adjust: q₂=6, running=0, 0+1=1 → remainder=1",
          "Quotient: 360, Remainder: 1",
        ],
      },
      actions: [
        { id: "check", label: "Check answer", primary: true },
  ...
  steps: [
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_2/VM_L2_5_SQUARES_NEAR50/intro-52-square.svg",
        },
      },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          expression: "54²",
          prompt: "d = 54 − 50 = 4. Now find left and right parts.",
  ...
  steps: [
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_2/VM_L2_6_FRACTIONS_SPEED/fraction-inspection-intro.svg",
        },
      },
      actions: [{ id: "next", label: "Show me the method", primary: true }],
    },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_2/VM_L2_6_FRACTIONS_SPEED/challenge-144-over-180.svg",
        },
      },
      practice: {
        mode: "numeric",
  ...
  steps: [
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_2/VM_L2_7_DECIMAL_SPEED/decimal-shift-intro.svg",
        },
      },
    ...
    },
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_2/VM_L2_7_DECIMAL_SPEED/concept-36-times-25-restore.svg",
        },
      },
      explanation: {
  ...
  steps: [
    {
      ...
      board: {
        ...
        data: {
          ...
          assetPath: "/math-svgs/level_2/VM_L2_8_DIVISION_FLAG/flag-division-intro-483-div-3.svg",
        },
      },
    ...
    {
      id: "guided_practice", label: "Guided Practice",
      tutorText: "Try 639 ÷ 3. Start: 6 ÷ 3 = ?",
      board: {
        type: "practice_board",
        data: {
          expression: "639 ÷ 3",
          prompt: "Step through each digit with the flag method.",
