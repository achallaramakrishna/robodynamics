set -e
TMP_DIR=/tmp/rd_course_import_cbse_grade_12_chemistry_part_1
COURSE_NAME='CBSE Grade 12 Chemistry (NCERT) - Part 1'
IMPORT_TAG='import_cbse_grade_12_chemistry_part_1_2026_03_04'

mkdir -p "$TMP_DIR"
mysql -uroot -pJatni@752050 robodynamics_db < "$TMP_DIR/tmp_course_import_cbse_grade_12_chemistry_part_1.sql"
