...
SELECT 'USERS', u.user_id, u.user_name, u.profile_id
FROM rd_users u
WHERE LOWER(u.user_name) IN ('madhuri','krishvi');

SELECT 'ENROLL', e.enrollment_id, e.student_id, e.course_id, e.enrollment_status
FROM rd_course_enrollments e
