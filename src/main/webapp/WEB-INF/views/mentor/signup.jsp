          ...
          <form method="post" action="${pageContext.request.contextPath}/mentors/signup" id="signupForm" novalidate>
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input class="form-control" name="firstName" required value="${prefill_firstName}" />
                <div class="invalid-feedback">Please enter your first name.</div>
              </div>
              <div class="col-md-6">
                <label class="form-label">Last name</label>
                <input class="form-control" name="lastName" value="${prefill_lastName}" />
              </div>
              ...
              <div class="col-12">
                ...
                <input class="form-control" name="cellPhone" required value="${prefill_cellPhone}"
              ...
              <div class="col-12">
                <p class="mt-3 mb-0 text-muted">
                  ...
                  <a href="${pageContext.request.contextPath}/login?next=${fn:escapeXml(param.next)}">Sign in</a>
                </p>
              </div>
            </div>
          </form>
