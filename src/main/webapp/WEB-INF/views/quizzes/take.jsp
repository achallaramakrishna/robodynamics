...
<div class="container my-4">
    ...
    <div class="col-12 col-md-7">
      <div class="card quiz-card shadow-soft">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div class="me-3">
            <label class="form-label mb-0">Questions per page</label>
          </div>
          ...
          <small class="text-muted ms-3">
            ...
            <strong>${startIdx}</strong> – <strong>${endIdx}</strong>
          </small>
        </div>
      </div>
    </div>
  ...
  <form id="quizForm" action="${pageContext.request.contextPath}/quizzes/navigate" method="post">
    <input type="hidden" name="quizId" value="${quiz.quizId}" />
    <input type="hidden" name="currentPage" value="${currentPage}" />
    <input type="hidden" name="pageSize" value="${pageSize}" />
    <input type="hidden" name="mode" value="${mode}" />
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <c:if test="${not empty question.examType}">
                    <span class="badge-exam">${question.examType}</span>
                  </c:if>
              ...
              <c:if test="${not empty question.questionImage}">
                <div class="q-image-wrap">
                  <a href="${question.questionImage}" target="_blank">
                    <img class="q-image img-fluid" src="${question.questionImage}" alt="Question image"/>
                  </a>
                  <div class="img-caption">Click to enlarge</div>
                </div>
              </c:if>
              ...
              <c:choose>
                    ...
                    <c:forEach var="option" items="${question.options}">
                      <label class="option-item d-block">
                        ...
                        <c:if test="${not empty option.optionImage}">
                          <div class="mt-2">
                            <a href="${option.optionImage}" target="_blank">
                              <img class="opt-image img-fluid" src="${option.optionImage}" alt="Option image"/>
                            </a>
                          </div>
                        </c:if>
                      </label>
                ...
                <c:when test="${question.questionType == 'short_answer'}">
                  <div class="form-floating">
                    <textarea class="form-control"
                              name="question_${question.questionId}_answer"
                              style="height:120px">${selectedAnswers[question.questionId]}</textarea>
                ...
                <c:when test="${question.questionType == 'long_answer'}">
                  <div class="form-floating">
                    <textarea class="form-control"
                              name="question_${question.questionId}_answer"
                              style="height:220px">${selectedAnswers[question.questionId]}</textarea>
