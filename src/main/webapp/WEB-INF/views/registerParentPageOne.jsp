...
<div class="container">
	...
	<f:form action="registerParentPageOne" modelAttribute="rdUser" method="post" onsubmit="disableSubmit()">
...
<%-- 					<div class="form-group input-field">
 ...
 --%>					<div class="form-group input-field">
					...
					<div class="form-group input-field">
						...
						<f:input type="text" path="city" class="form-control input"
							id="city" aria-describedby="emailHelp" />
					</div>
					<div class="form-group input-field">
						<label for="state">State</label>
						<f:input type="text" path="state" class="form-control input"
