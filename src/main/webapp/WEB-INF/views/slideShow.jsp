...
<body>
    <div class="container-fluid">
        ...
        <div class="slide-container" style="display: flex; align-items: center; justify-content: center;">
            ...
            <!-- Slide Content -->
            <div class="content-box" style="${empty slide.fileUrl ? 'width: 100%;' : ''} max-width: 600px;">
		...
		<div class="nav-buttons">
		    <form action="${pageContext.request.contextPath}/sessiondetail/navigateSlides" method="post" class="d-inline">
		        <input type="hidden" name="currentSlide" value="${currentSlide}" />
		        <input type="hidden" name="sessionDetailId" value="${sessionDetailId}" />
		        <input type="hidden" name="enrollmentId" value="${enrollmentId}" />  <!-- Pass enrollmentId -->
