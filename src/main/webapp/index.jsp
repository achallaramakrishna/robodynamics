...
<body>
        ...
        <section id="video-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <iframe src="https://www.youtube.com/embed/YhOtWdxcxTg?rel=0&enablejsapi=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="carousel-item">
                    <iframe src="https://www.youtube.com/embed/n0X3PkSYvkM?rel=0&enablejsapi=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <iframe src="https://www.youtube.com/embed/d9UtPD2BINc?rel=0&enablejsapi=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Flying Drones</h5>
                    </div>
                ...
                <div class="carousel-item">
                    <iframe src="https://www.youtube.com/embed/CPfq7DFuHA4?rel=0&enablejsapi=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Flying Drones</h5>
                    </div>
            ...
            <div class="thumbnail text-center">
                <img src="https://img.youtube.com/vi/YhOtWdxcxTg/0.jpg" data-target="#video-carousel" data-slide-to="0" class="active">
                <img src="https://img.youtube.com/vi/n0X3PkSYvkM/0.jpg" data-target="#video-carousel" data-slide-to="1">
                <img src="https://img.youtube.com/vi/d9UtPD2BINc/0.jpg" data-target="#video-carousel" data-slide-to="2">
                <img src="https://img.youtube.com/vi/CPfq7DFuHA4/0.jpg" data-target="#video-carousel" data-slide-to="3">
            </div>
        </section>
    ...
    <section class="bg-navbar-gradient py-5 text-center">
        <div class="container">
            ...
            <a href="subscription.jsp" class="btn btn-primary btn-lg">Enroll Now</a>
        </div>
    </section>
