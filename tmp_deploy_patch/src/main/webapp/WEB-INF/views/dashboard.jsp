        ...
        <div class="col-lg-8 mb-4">
          <div class="card shadow-sm h-100">
            <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
              <h5 class="mb-0">Visitor Insights (Last 7 Days)</h5>
              <small>Real traffic from rd_visitor_logs</small>
            </div>
            <div class="card-body">
              <div class="row g-2 mb-3 text-center">
                <div class="col-6 col-md-3">
                  <div class="border rounded p-2">
                    <div class="small text-muted">Visits (24h)</div>
                    <div class="fw-bold">
                      <c:out value="${visitorStats.visits24h != null ? visitorStats.visits24h : 0}" />
                    </div>
                  </div>
                </div>
                <div class="col-6 col-md-3">
                  <div class="border rounded p-2">
                    <div class="small text-muted">Visits (7d)</div>
                    <div class="fw-bold">
                      <c:out value="${visitorStats.visits7d != null ? visitorStats.visits7d : 0}" />
                    </div>
                  </div>
                </div>
                <div class="col-6 col-md-3">
                  <div class="border rounded p-2">
                    ...
                    <div class="fw-bold">
                      <c:out value="${visitorStats.uniqueIps7d != null ? visitorStats.uniqueIps7d : 0}" />
                    </div>
                  </div>
                </div>
                <div class="col-6 col-md-3">
                  <div class="border rounded p-2">
                    ...
                    <div class="fw-bold">
                      <c:out value="${visitorStats.distinctUrls7d != null ? visitorStats.distinctUrls7d : 0}" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex flex-wrap gap-2 mb-3">
                <span class="badge text-bg-success">
                  Logged in visits
                  <span class="badge bg-light text-dark ms-1">
                    <c:out value="${visitorStats.loggedInVisits7d != null ? visitorStats.loggedInVisits7d : 0}" />
                  </span>
                </span>
                <span class="badge text-bg-secondary">
                  Anonymous visits
                  <span class="badge bg-light text-dark ms-1">
                    <c:out value="${visitorStats.anonymousVisits7d != null ? visitorStats.anonymousVisits7d : 0}" />
                  </span>
                </span>
                <span class="badge text-bg-primary">
                  AptiPath hits
                  <span class="badge bg-light text-dark ms-1">
                    <c:out value="${visitorStats.aptiPathVisits7d != null ? visitorStats.aptiPathVisits7d : 0}" />
                  </span>
                </span>
                <span class="badge text-bg-warning text-dark">
                  Demo page hits
                  <span class="badge bg-light text-dark ms-1">
                    <c:out value="${visitorStats.demoVisits7d != null ? visitorStats.demoVisits7d : 0}" />
                  </span>
                </span>
                <span class="badge text-bg-info text-dark">
                  Login page hits
                  <span class="badge bg-light text-dark ms-1">
                    <c:out value="${visitorStats.loginPageVisits7d != null ? visitorStats.loginPageVisits7d : 0}" />
                  </span>
                </span>
              </div>
