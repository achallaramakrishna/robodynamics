          ...
          <c:choose>
            <c:when test="${empty sessionScope.rdUser}">
              <c:choose>
                ...
                <c:otherwise>
                  <a class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/parents/demo?source=header_aptipath360&utm_source=header&utm_medium=cta&utm_campaign=aptipath360_demo">Book AptiPath360 Demo</a>
                </c:otherwise>
              </c:choose>
