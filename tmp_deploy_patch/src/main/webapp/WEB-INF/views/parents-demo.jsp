...
<c:set var="demoSource" value="${empty param.source ? 'home_parent_simple' : param.source}" />
<c:set var="isAptiPath360Demo" value="${fn:contains(fn:toLowerCase(demoSource), 'aptipath360')}" />
