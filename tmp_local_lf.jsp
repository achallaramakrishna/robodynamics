...
<head>
  ...
  <style>
    ...
    *::-webkit-scrollbar { width: 0 !important; height: 0 !important; display: none !important; }
    ...
    .section-tabs-shell::-webkit-scrollbar { height: 3px; }
    .section-tabs-shell::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 999px; }
  ...
  <script>
    (function() {
      ...
      function renderQuestion() {
        ...
        if (questionRoot) {
          const remove = [
            'section-core-aptitude',
            'section-applied-challenge',
            'section-interest-work',
            'section-values-motivation',
            'section-learning-behavior',
            'section-ai-readiness',
            'section-career-reality'
          ];
          questionRoot.classList.remove.apply(questionRoot.classList, remove);
          questionRoot.classList.add(sectionCssClass(question.sectionCode));
        }
