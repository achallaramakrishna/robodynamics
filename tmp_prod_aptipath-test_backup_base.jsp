...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .question-shell::-webkit-scrollbar { width: 5px; }
    .question-shell::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 999px; }
    ...
    @media (max-width: 980px) {
      ...
      .question-shell { overflow: visible; flex: none; }
