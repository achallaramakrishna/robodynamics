...
tar -xzf /tmp/ai_tutor_minimal_surface.tgz -C /tmp
...
rm -rf .next
echo "NEXT_CLEANED"
npm run build >/tmp/rd_ai_tutor_web_build_minimal_surface.log 2>&1 || (tail -n 120 /tmp/rd_ai_tutor_web_build_minimal_surface.log; exit 1)
