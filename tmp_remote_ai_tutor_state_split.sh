...
tar -xzf /tmp/ai_tutor_state_split.tgz -C /tmp
...
rm -rf .next
echo "NEXT_CLEANED"
npm run build >/tmp/rd_ai_tutor_web_build_state_split.log 2>&1 || (tail -n 120 /tmp/rd_ai_tutor_web_build_state_split.log; exit 1)
