...
tar -xzf /tmp/ai_tutor_student_turn.tgz -C /tmp
...
rm -rf .next
echo "NEXT_CLEANED"
npm run build >/tmp/rd_ai_tutor_web_build_student_turn.log 2>&1 || (tail -n 120 /tmp/rd_ai_tutor_web_build_student_turn.log; exit 1)
