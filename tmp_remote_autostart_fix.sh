...
install -D -m 644 /tmp/ms_TutorClient.tsx $WEB/ai-tutor/tutor/TutorClient.tsx
cd /opt/robodynamics/ai-tutor/web
npm run build >/tmp/rd_ai_tutor_web_build_autostart.log 2>&1 || (tail -n 120 /tmp/rd_ai_tutor_web_build_autostart.log; exit 1)
