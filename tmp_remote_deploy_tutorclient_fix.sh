set -e
TARGET=/opt/robodynamics/ai-tutor/web/app/ai-tutor/tutor/TutorClient.tsx
BACKUP=/opt/robodynamics/ai-tutor/web/app/ai-tutor/tutor/TutorClient.prodbackup.20260313-184708.tsx
cp "$TARGET" "$BACKUP"
cat <<'EOF' > "$TARGET"
"use client";
