set -e
TMP_DIR=/tmp/rd_course_import_cbse_grade_10_maths
COURSE_NAME='CBSE Grade 10 Mathematics (NCERT)'
IMPORT_TAG='import_cbse_grade_10_maths_2026_03_04'

mkdir -p "$TMP_DIR"
mysql -uroot -pJatni@752050 robodynamics_db < "$TMP_DIR/tmp_course_import_cbse_grade_10_maths.sql"
