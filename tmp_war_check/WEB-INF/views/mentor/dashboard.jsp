...
<body class="rd-shell-page">
  ...
  <div class="rd-shell">
    <section class="rd-hero">
      <div>
        <p class="rd-eyebrow">Robo Dynamics Mentor Workspace</p>
        <h1 class="rd-hero-title">Mentor Dashboard</h1>
        <p class="rd-hero-sub">
          Manage classes, assignments, tests, leads, and learner support from one place.
        </p>
      </div>
      <div class="rd-hero-meta">
        <div class="rd-meta-card">
          <div class="rd-meta-label">Role</div>
          <div class="rd-meta-value">Robo Mentor</div>
        </div>
        <div class="rd-meta-card">
          <div class="rd-meta-label">Portal</div>
          <div class="rd-meta-value">Teaching Operations</div>
        </div>
      </div>
    </section>
    ...
    <div class="d-flex justify-content-end mb-3">
      <button class="btn btn-outline-primary btn-sm"
              ...
              data-bs-target="#mentorCalendarCollapse"
              aria-expanded="false"
              aria-controls="mentorCalendarCollapse">
        View Calendar
      </button>
    </div>

    <div class="collapse mb-4" id="mentorCalendarCollapse">
      <div class="row">
        <div class="col-12">
...
<div class="row mt-4">
  ...
  (function(){
    ...
    const collapseEl = document.getElementById('mentorCalendarCollapse');
    let calendar = null;
    ...
    document.querySelectorAll('#mentorCalendarCollapse [data-view]').forEach(btn=>{
