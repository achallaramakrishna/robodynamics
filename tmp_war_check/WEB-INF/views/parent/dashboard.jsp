...
<div class="rd-shell">
    <section class="rd-hero">
        <div>
            <p class="rd-eyebrow">Robo Dynamics Family Workspace</p>
            <h1 class="rd-hero-title">Parent Dashboard</h1>
            <p class="rd-hero-sub">
                Manage your child's learning, competitions, tests, and progress with clear visibility.
            </p>
        </div>
        <div class="rd-hero-meta">
            <div class="rd-meta-card">
                <div class="rd-meta-label">Role</div>
                <div class="rd-meta-value">Robo Parent</div>
            </div>
            <div class="rd-meta-card">
                <div class="rd-meta-label">Portal</div>
                <div class="rd-meta-value">Parent Control Center</div>
            </div>
        </div>
    </section>
