...
<div class="container my-4">
  <div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <a class="btn btn-outline-secondary"
       href="${pageContext.request.contextPath}/parent/school-tests/view?testId=${test.testId}">Back to Test</a>
  </div>
  ...
  <form method="post" action="${pageContext.request.contextPath}/parent/school-tests/map-sessions" id="mapForm">
    ...
    <div class="card shadow-sm">
      ...
      <div class="card-footer d-flex gap-2">
        ...
        <a class="btn btn-outline-secondary"
           href="${pageContext.request.contextPath}/parent/school-tests/view?testId=${test.testId}">Cancel</a>
      </div>
    </div>
  </form>
</div>
